...
const PDFDropzone = () => {
    ...
    const { value: isFeatureEnabled, featureUsageExceeded, featureAllocation, featureUsage } = useSchematicEntitlement('scanner')
                    ...
                    {isUploading ? (
                        ...
                        <>
                            ...
                            <p className="mt-2 text-sm text-gray-600">
                                <strong>Upload your study PDFs.</strong> Drag and drop your file here, or click <strong>Select files</strong>.
                                <em> Only upload PDFs that cover the topics you’re currently focusing on.</em>
                            </p>
